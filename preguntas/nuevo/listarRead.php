        ...
        <section id="content">
          ...
          <div id="breadcrumbs-wrapper">
           ...
           <a href="#modal1" class="btn waves-effect waves-light indigo modal-trigger"><i class="fa fa-plus-square"></i> Nuevo</a>
            <a href="listarRE.php?idmcod=<?php echo $idmcod ?>&idacod=<?php echo $idacod ?>" class="btn waves-effect waves-light blue"><i class="fa fa-reply"></i> Atras</a> 
           <div id="modal1" class="modal modal-fixed-footer">
                  <div class="modal-content">
                       <form class="col s12" id="idform" action="return false" onsubmit="return false" method="POST">
                         ...
                         <div class="col s12 m12"  align="center">
                            <label style="font-size:20px; color:#66ae43; font-weight: bold;">NUEVA PREGUNTA - READING</label>
                          </div>  
            ...
            <div class="section">
              <div class="row">
                    ...
                    <div class="col s12 m12"  align="center">
                      <label style="font-size:20px; font-weight: bold;">Referencia:</label> <label style="font-size:20px; color:#00838f; font-weight: bold;"><?php echo $re['nombre']; ?></label>
                    </div>
                    <div class="col s12 m1">&nbsp;</div> 
                    <div class="col s12 m10" style=" text-align:justify;">
                      <label style="font-size:20px; font-weight: bold; ">Texto:</label> <label style="font-size:15px; color:#006064; font-weight: bold;"><?php echo $re['descripcion']; ?></label>
                    </div> 
                    <div class="col s12 m1">&nbsp;</div> 
              ...
              <div id="table-datatables">
                ...
                <tbody>
                      ...
                      <!--  <button class="btn-jh waves-effect waves-light blue"><i class="mdi-action-assignment"></i> Modificar</button> -->
                          <a href="modificarRead.php?idmcod=<?php echo $idmcod ?>&idacod=<?php echo $idacod ?>&idrcod=<?php echo $idrcod ?>&idpcod=<?php echo $idpcod ?>" class="btn-jh waves-effect waves-light blue"><i class="mdi-action-assignment"></i> Editar</a>  
