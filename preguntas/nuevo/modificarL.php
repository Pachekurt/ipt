      ...
      <div class="wrapper">
        ...
        <section id="content">
          ...
          <div id="breadcrumbs-wrapper">
            ...
            <a href="listarL.php?idmcod=<?php echo $idmcod ?>&idacod=<?php echo $idacod ?>&idrcod=<?php echo $idrcod ?>" class="btn waves-effect waves-light blue"><i class="fa fa-reply"></i> Atras</a> 
