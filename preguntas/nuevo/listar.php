              ...
              <div id="table-datatables">
                ...
                <tbody>
                      ...
                      <!--  <button class="btn-jh waves-effect waves-light blue"><i class="mdi-action-assignment"></i> Modificar</button> -->
                         <a href="modificar.php?idpcod=<?php echo $idpcod ?>&idmcod=<?php echo $idmcod ?>&idacod=<?php echo $idacod ?>" class="btn-jh waves-effect waves-light blue"><i class="mdi-action-assignment"></i> Editar</a> 
