...
<head>
    <?php
      $hd_titulo="Actualizar datos de la pregunta de ".$do['nombre'];
            ...
            <div class="container">
              <div class="row">
                <div class="col s12 m12 l12">
                  ...
                  <?php echo $idm.$ida.$idp ?>
                </div>
              </div>
            </div>
          </div>
            <a href="listarWrit.php?idmcod=<?php echo $idmcod ?>&idacod=<?php echo $idacod ?>" class="btn waves-effect waves-light blue"><i class="fa fa-reply"></i> Atras</a> 
              ...
              <div class="col s12 m8">
                   <form class="col s12" id="idform" action="return false" onsubmit="return false" method="POST">
                         ...
                         <div class="col s12 m12"  align="center">
                            <label style="font-size:20px; color:#66ae43; font-weight: bold;">ACTUALIZAR DATOS - WRITING</label>
                          </div>  
                    <div class="formcontent col s12 m12">
                      <div class="row">  
                        ...
                        <div class="input-field col s12 m9">
                           <textarea id="iddetalle" name="iddetalle" type="text" class="validate" style="height:150px;"><?php echo $pr['detalle']; ?></textarea>
                        </div>
