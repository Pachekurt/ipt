...
<body>
      ...
      <div class="wrapper">
        ...
        <section id="content">
          ...
          <div id="breadcrumbs-wrapper">
           ...
           <a href="#modal1" class="btn waves-effect deep-orange lighten-1 indigo modal-trigger"><i class="mdi-action-list"></i> Nuevo referencia</a>
                  ...
                  <div class="modal-content">
                       <form class="col s12" id="idform" action="return false" onsubmit="return false" method="POST">
                         ...
                         <div class="col s12 m12"  align="center">
                            <label style="font-size:20px; color:#66ae43; font-weight: bold;">Nuevo referencia  (READING)</label>
                    ...
                    <div class="formcontent col s12 m12">
                      <div class="row">  
                        ...
                        <div class="input-field col s12 m9">
                          ...
                          <label for="idnombre">Titulo</label>
                        </div>                 
                        ...
                        <div class="input-field col s12 m9">
                           <textarea id="iddetalle" name="iddetalle" type="text" class="validate" style="height:200px;"></textarea>
                        </div>
            ...
            <div class="section">
              ...
              <div id="table-datatables">
                ...
                <tbody>
                      ...
                      foreach($referencia->mostrarTodo("idmodulo=".$idm." and tipo=2") as $f)
                      {
                        $idrcod=ecUrl($f['idreferencia']);
                      ?>
                      <tr style="color: #006064;">
                        <td><?php echo $f['nombre']; ?></td>
                        <td style="text-align:justify;"><?php echo $f['descripcion']; ?></td>
                        <td style="width:14%;">
                     
                      <button class="btn-jh waves-effect deep-orange lighten-2" onclick="selreferencia('<?php echo $idrcod ?>');"><i class="mdi-content-add-circle-outline"></i>Preguntas</button> 
          ...
          <div id="modal2" class="modal modal-fixed-footer">
                  <div class="modal-content">
                       <form class="col s12" id="idform2" action="return false" onsubmit="return false" method="POST">
                         ...
                         <input id="idacod" name="idacod" value="<?php echo $idacod ?>" type="hidden" >
                         <div class="col s12 m12"  align="center">
                            <label style="font-size:20px; color:#66ae43; font-weight: bold;">Actualizar datos referencia  (READING)</label>
                    ...
                    <div class="formcontent col s12 m12">
                      <div class="row">  
                        ...
                        <div class="input-field col s12 m9">
                           <textarea id="iddetalle2" name="iddetalle2" type="text" class="validate" style="height:200px;"></textarea>
                        </div>
                     ...
                     <div class="modal-footer" align="right">                      
                       <button id="btnSave2" class="btn waves-effect light-blue darken-4 indigo" onclick="actualizar();"><i class="fa fa-save"></i> ATUALIZAR</button>
                       <button class="btn waves-effect waves-light red modal-close" ><i class="mdi-content-reply"></i> Cancelar</button>                                                        
                        </div>
                </div>
          <?php
      ...
      function selreferencia(idrcod)
   {
    ...
    idacod='<?php echo $idacod; ?>';
         ...
         location.href="listarRead.php?idmcod="+idmcod+"&idacod="+idacod+"&idrcod="+idrcod;         
