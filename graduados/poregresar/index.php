            ...
            <div class="section">
             ...
             <a href="notas.php" class="btn waves-effect waves-light blue"><i class="fa fa-reply"></i> IMPRIMIR NOTAS</a> 
              ...
              <div class="row">
                ...
                <tbody>
                      <?php
                      foreach($vestudiantefull->mostrarTodo("idsede=".$idsede." and estado in(1,2) and idmodulo =10 and estadoacademico in (148,149) ") as $f)
                      {
                      ...
                      <tr style="<?php echo $style ?>" >
                        ...
                        <td>
                            ...
                            <button id="btngradua" class="btn waves-effect light-green darken-4 indigo" onclick="graduar('<?php echo $f['idestudiante'] ?>');"><i class="mdi-action-assignment-turned-in"></i>GRADUAR</button>
                       </td>
