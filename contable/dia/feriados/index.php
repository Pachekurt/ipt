            ...
            <div class="row">
                    ...
                    <form class="col s12" id="idform" action="return false" onsubmit="return false" method="POST">
                     ...
                     <div class="row">
                      <div class="input-field col s12 m12 l12">
                          <input id="idgestion" name="idgestion" type="text" value="<?php echo $gestion ?>" class="validate">
                          <label for="idgestion">Gestion</label>
                        </div>
                        <div class="input-field col s12 m12 l12">
                          <input id="idfecha" name="idfecha" type="date" value="<?php echo date('Y-m-d'); ?>" class="validate">
                          <label for="idfecha">Fecha Feriado</label>
                        </div>
                        <div class="input-field col s12 m12 l12">
                          <input id="idobs" name="idobs" type="text" class="validate">
                          <label for="idobs">Nombre del Feriado</label>
                        </div>
                        <div class="input-field col s12 m6 l6">
                          <a style="width: 100%" href="../" class="btn waves-effect waves-light blue"><i class="fa fa-reply"></i> Atras </a>
                        </div>
                        <div class="input-field col s12 m6 l6">
                          <a style="width: 100%" id="btnSave" class="btn waves-effect waves-light darken-3 green"> AGREGAR FECHA <i class="fa fa-arrow-right"></i></a>
                        </div>
                      </div>
                    </form>
              </div>
              <div class="col s12 m6 l6">
                ...
                <table class="tablabasico">
                  ...
                  <tbody>
                    <?php
                    foreach($ctbferiado->mostrarTodo("idgestion=".$ddia['idgestion']) as $f)
                    {
                      ?>
                    <tr>
