            ...
            <div class="container">
              <div class="row">
                <div class="col s12 m12 l12">
                  <h5 class="breadcrumbs-title"><i class="fa fa-tag"></i><?php echo $hd_titulo; ?> <a href="../"><i class="fa fa-reply"></i> Volver</a> / <a href="../prejuridica/">Pre-juridica</a> </h5>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                <form id="idform" action="return false" onsubmit="return false" method="POST">
                  <table id="example" class="display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <?php
                      foreach($cobcartera->mostrarTodo("idejecutivo=3 and saldo>0 idsede=$idsede") as $f)
                      {
