...
/******************    SEGURIDAD *************/
extract($_GET);
$dsede=$sede->muestra("idsede=$idsede");
...
<table border="0" align="center" width="100%">
    <tr>
        <td class="titulo"> CARTERA'.$titulo.' AL <br>'.strtoupper(obtenerFechaLetra($fechaGen)).' </td>
    </tr>
 </table><br><br>
';
// CARTERA VIGENTE 
...
$i=1;
    foreach($cobcartera->mostrarTodo("saldo>0 and estado=131 and idejecutivo>5 and idsede=$idsede","fechaproxve") as $f){
        ...
        <tr>
            ...
            <td class="textocentro sfila">'.crestantes($f['monto']-$f['pagadoprod'],$f['saldo'],$dcp['cuotas'])." de ".($dcp['cuotas']+1).'</td>
...
$pdf->SetFont('helvetica', '', 6);
$i=1;
    foreach($cobcartera->mostrarTodo("saldo>0 and estado=133 and idejecutivo>5 and idsede=$idsede","fechaproxve") as $f){
        $dct=$admcontrato->muestra($f['idcontrato']);
        $deje=$vejecutivo->muestra($f['idejecutivo']);
        $destado=$dominio->muestra($f['estado']);
        $dcp=$vcontratoplan->muestra($f['idcontrato']);
...
$pdf->SetFont('helvetica', '', 6);
$i=1;
    foreach($cobcartera->mostrarTodo("saldo>0 and idejecutivo=1 and idsede=$idsede","fechaproxve") as $f){
        $dct=$admcontrato->muestra($f['idcontrato']);
        $deje=$vejecutivo->muestra($f['idejecutivo']);
        $destado=$dominio->muestra($f['estado']);
        $dcp=$vcontratoplan->muestra($f['idcontrato']);
...
$pdf->SetFont('helvetica', '', 6);
$i=1;
    foreach($cobcartera->mostrarTodo("saldo>0 and idejecutivo=2 and idsede=$idsede","fechaproxve") as $f){
        $dct=$admcontrato->muestra($f['idcontrato']);
        $deje=$vejecutivo->muestra($f['idejecutivo']);
        $destado=$dominio->muestra($f['estado']);
        $dcp=$vcontratoplan->muestra($f['idcontrato']);
...
$pdf->SetFont('helvetica', '', 6);
$i=1;
    foreach($cobcartera->mostrarTodo("saldo>0 and idejecutivo=3 and idsede=$idsede","fechaproxve") as $f){
        $dct=$admcontrato->muestra($f['idcontrato']);
        $deje=$vejecutivo->muestra($f['idejecutivo']);
        $destado=$dominio->muestra($f['estado']);
        $dcp=$vcontratoplan->muestra($f['idcontrato']);
...
<table border="0" width="100%">
    <tr>
        <td class="titulo"> CARTERA EN ADMINISTRACION  </td>
    </tr>
 </table>
<table border="0" cellpadding="0" width="100%">
    <tr style="background-color:#dddddd;font-weight: bold;">
...
$pdf->SetFont('helvetica', '', 6);
$i=1;
    foreach($cobcartera->mostrarTodo("saldo>0 and idejecutivo=5 and idsede=$idsede","fechaproxve") as $f){
        $dct=$admcontrato->muestra($f['idcontrato']);
        $deje=$vejecutivo->muestra($f['idejecutivo']);
        $destado=$dominio->muestra($f['estado']);
        $dcp=$vcontratoplan->muestra($f['idcontrato']);
