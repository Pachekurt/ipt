...
$nroplanilla=diferenciaDias(obtenerAnio($fechaGen)."-01"."-01", $fechaGen);
...
<table border="0" align="center" cellpadding="2" width="100%">
  <tr style="background-color:#dddddd;">
    <td class="cabecera2 textocentro" width="45"> Ing. Caja </td>
...
$pdf->SetFont('helvetica', '', 6);
  $montoDep=0;
  $montoDesc=0;
  $dDep=$cobcarteradet->mostrarTodo("consolidado=2 and tipopago=1 and fecha='$fechaGen'");
  $tenor="";
  if (count($dDep)>0) {
    $tenor="TOTAL :";
  }
  ...
  foreach($cobcarteradet->mostrarTodo("consolidado=2 and tipopago=1 and fecha='$fechaGen'","nro") as $f)
  {
  ...
  <table border="0" align="center" cellpadding="2" width="100%">
      <tr>
      <td class="sfila cabecera2 sMoneda" width="431">'.$tenor.'</td>
...
$pdf->SetFont('helvetica', '', 6);
  ...
  <table border="0" align="center" cellpadding="2" width="100%">
      <tr>
      <td class="sfila cabecera2 sMoneda" width="471">'.$tenor.'</td>
...
$pdf->SetFont('helvetica', '', 7);
  $montoTotal=0;
  $dDep=$factura->mostrarTodo("estado=2 and fechanul='$fechaGen'","nro");
  $tenor="";
  if (count($dDep)>0) {
    $tenor="VALOR ANULADO :";
  }
  ...
  foreach($factura->mostrarTodo("estado=2 and fechanul='$fechaGen'","nro") as $f)
  {
...
<table border="0" align="center" cellpadding="2" width="60%">
  <tr>
    <td class="sfila textoIZ" width="90%"> IMPORTES DEPOSITADOS EN EL DIA </td>
    <td class="sfila sMoneda" width="10%">'.number_format($montoDep, 2, '.', ' ').'</td>
  </tr>
  <tr>
    <td class="sfila textoIZ" width="90%"> TARJETAS DE CREDITO RECIBIDAS </td>
    <td class="sfila sMoneda" width="10%"> '.number_format($montoTj, 2, '.', ' ').' </td>
  </tr>
  <tr>
    <td class="sfila cabecera2 textoIZ" width="90%"> EFECTIVO DEPOSITADO EN EL BANCO </td>
    <td class="sfila cabecera2 sMoneda" width="10%"> '.number_format($montoDep+$montoTj, 2, '.', ' ').' </td>
  </tr>
</table>
 ';
