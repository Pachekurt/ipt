...
<table width="100%"  align="center">
  <tr>
    ...
    <td width="50%"><br>
      <div class="tituloFactura">PARTE DIARIO DE COBRANZA-INGLES PARA TODOS<br>'.strtoupper(obtenerFechaLetra($fechaGen)).'</div>
    </td>
    <td width="20%"><br>
    <table border="1">
      <tr>
...
<table border="0" align="center" cellpadding="2" width="100%">
  <tr style="background-color:#dddddd;">
    ...
    <td class="cabecera2 textocentro" width="34"> Moneda </td>
    <td class="cabecera2 textocentro" width="27"> Cuota </td>
    <td class="cabecera2 textocentro" width="40"> Saldo Ant. </td>
    <td class="cabecera2 textocentro" width="40"> Monto </td>
    <td class="cabecera2 textocentro" width="40"> Desc. </td>
    <td class="cabecera2 textocentro" width="40"> Saldo Act. </td>
...
$pdf->SetFont('helvetica', '', 6);
  ...
  $montoDesc=0;
  $cantDep=0;
  $dDep=$vcarteradet->mostrarTodo("consolidado=2  and idsede=$idsede and tipopago=1 and fecha='$fechaGen'");
  $tenor="";
  if (count($dDep)>0) {
    $tenor="TOTAL :";
  }
  ...
  foreach($vcarteradet->mostrarTodo("consolidado=2 and idsede=$idsede and tipopago=1 and fecha='$fechaGen'","fechadep,horadep") as $f)
  {
    $cantDep++;
    $montoDep=$montoDep+$f['monto'];
    $montoDesc=$montoDesc+$f['descuento'];
    $dfact=$factura->muestra($f['idfactura']); 
    $dus=$usuario->muestra($f['usuariocreacion']);
    $dcar=$vcartera->muestra($f['idcartera']);
    $dusu=$usuario->mostrarUltimo("idadmejecutivo=".$dcar['idejecutivo']);
    $totalcuotas=$dcar['cuotas']+1;
    $tipo="";
    $codigoP="";
    switch ($f['tipopago']) {
      case 1:
    ...
    <tr>
      ...
      <td class="sfila textocentro"> '.$dcar['ntitular'].'</td>
      <td class="sfila textocentro"> '.$dcar['carnet'].'</td>
      <td class="sfila textocentro"> '.$dcar['cuenta'].'</td>
      <td class="sfila textocentro"> '.$dcar['nrocontrato'].'</td>
      <td class="sfila textocentro"> '.$dfact['nro'].'</td>
      <td class="sfila textocentro"> '.$f['moneda'].'</td>
      <td class="sfila textocentro"> '.$f['cuota'].'*'.$totalcuotas.'</td>
      ...
      <td class="sfila textocentro"> '.strtoupper ($dusu['usuario']).'</td>
  ...
  <table border="0" align="center" cellpadding="2" width="100%">
      ...
      <td class="sfila cabecera2 sMoneda" width="40"> '.number_format($montoDep, 2, '.', ' ').'</td>
      <td class="sfila cabecera2 sMoneda" width="40"> '.number_format($montoDesc, 2, '.', ' ').'</td>
    </tr>
 </table>
 <br><br><br>
 <table width="100%" cellpadding="1">
...
<table border="0" align="center" cellpadding="2" width="100%">
  <tr style="background-color:#dddddd;">
    <td class="cabecera2 textocentro" width="45"> Fecha Dep </td>
    <td class="cabecera2 textocentro" width="45"> Hora Dep </td>
    <td class="cabecera2 textocentro" width="90"> Titular </td>
    <td class="cabecera2 textocentro" width="50"> Carnet </td>
    <td class="cabecera2 textocentro" width="35"> Cuenta </td>
    <td class="cabecera2 textocentro" width="38"> Matricula </td>
    <td class="cabecera2 textocentro" width="35"> Factura </td>
    <td class="cabecera2 textocentro" width="34"> Moneda </td>
    <td class="cabecera2 textocentro" width="27"> Cuota </td>
    <td class="cabecera2 textocentro" width="37"> Nro. Lote </td>
    <td class="cabecera2 textocentro" width="37"> Ref. </td>
    <td class="cabecera2 textocentro" width="40"> Saldo Ant. </td>
    <td class="cabecera2 textocentro" width="40"> Monto </td>
    <td class="cabecera2 textocentro" width="40"> Desc. </td>
    <td class="cabecera2 textocentro" width="40"> Saldo Act. </td>
...
$pdf->SetFont('helvetica', '', 6);
  ...
  <table border="0" align="center" cellpadding="2" width="100%">
      <tr>
      <td class="sfila cabecera2 sMoneda" width="511">'.$tenor.'</td>
      <td class="sfila cabecera2 sMoneda" width="40"> '.number_format($montoTj, 2, '.', ' ').'</td>
      <td class="sfila cabecera2 sMoneda" width="40"> '.number_format($montoDesc, 2, '.', ' ').'</td>
    </tr>
 </table>
<br><br><br>
 <table width="50%" cellpadding="1">
  <tr style="background-color:#dddddd;">
    <td class="cabecera3" style="text-align:center; font-size:10px;">SERVICIOS ADICIONALES EN EL DIA</td>
  </tr>
</table>
 ';
 $html=$html.'
<table border="0" align="center" cellpadding="2" width="100%">
  <tr style="background-color:#dddddd;">
    ...
    <td class="cabecera2 textocentro" width="55"> Factura </td>
...
$pdf->SetFont('helvetica', '', 7);
  $montoServ=0;
  $cantServ=0;
  $dDep=$vfactura->mostrarTodo("tipotabla='SERV. AD.' and idsede=$idsede and consolidado=2 and estado=1 and fecha='$fechaGen'");
  $tenor="";
  if (count($dDep)>0) {
    $tenor="TOTAL :";
  }
  ...
  foreach($vfactura->mostrarTodo("tipotabla='SERV. AD.' and idsede=$idsede and consolidado=2 and estado=1 and fecha='$fechaGen'","fechadep,horadep") as $f)
  {
    $cantServ++;
    $montoServ=$montoServ+$f['total'];
    $dus=$usuario->muestra($f['usuariocreacion']);
    $estado="";
    switch ($f['estado']) {
      case '1':
    ...
    <tr>
      ...
      <td class="sfila sMoneda"> '.number_format($f['total'], 2, '.', ' ').'</td>
  ...
  <table border="0" align="center" cellpadding="2" width="100%">
      ...
      <td class="sfila cabecera2 sMoneda" width="55"> '.number_format($montoServ, 2, '.', ' ').'</td>
    </tr>
 </table>
 <br><br><br>
 <table width="50%" cellpadding="1">
...
<table border="0" align="center" cellpadding="2" width="60%">
  ...
  <tr>
    <td class="sfila textoIZ" width="10%"> '.$cantServ.' </td>
    <td class="sfila textoIZ" width="70%"> SERVICIOS ADICIONALES EN EL DIA </td>
    <td class="sfila sMoneda" width="20%"> '.number_format($montoServ, 2, '.', ' ').' </td>
  </tr>
  <tr style="font-size:10px;">
    ...
    <td class="sfila cabecera2 sMoneda" width="20%"> '.number_format($montoDep+$montoTj+$montoServ, 2, '.', ' ').' </td>
  </tr>
</table>
 ';
