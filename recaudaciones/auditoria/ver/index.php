                ...
                <div class="col s12 m12 l12">
                  <h5 class="breadcrumbs-title">
                    ...
                    <?php 
                      ...
                      }elseif ($idejecutivo==2) {
                        echo "PRE-JURIDICA";
                      
                    }elseif ($idejecutivo==5) {
                        echo "ADMINISTRACION";
                      }
                      else{
                ...
                <form id="idform" action="return false" onsubmit="return false" method="POST">
                  <table id="example" class="display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      ...
                      $i=0;
                      $saldo=0;
                      foreach($vcartera->mostrarTodo("auditado=0 and idejecutivo=$idejecutivo and idsede=$idsede") as $f)
                      {
                        $i++;
                        $saldo=$saldo+$f['saldo'];
                      ...
                      <tr style="<?php echo $styleP ?>">
                        ...
                        <td>
                          <a target="_blank" class="linkRow" href="../../cartera/cobrar/?lblcode=<?php echo $lblcode ?>">Cobro</a> / 
