  ...
  if($cobcarteradet->insertar($val2))/**************************************************************/
  {
    ...
    if ($idmonto+$idadelanto>0) {
      ...
      if($factura->insertar($val3)){
        ...
        $cobcarteradet->actualizar($valFactura,$iddet);
        /************************************** PAGO  CON  ADELANTO ***************************************/
    ...
    ?>
      <script type="text/javascript">
        setTimeout(function() {
          Materialize.toast('<span>2 No se pudo realizar el registro</span>', 1500);
        }, 10);
      </script>
    <?php
  }
