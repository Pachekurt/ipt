...
<table width="100%" cellpadding="1">
    ...
    <td>
      <table width="100%" cellpadding="3">
        <tr>
          ...
          <td width="200">'.$dcontrato['nrocontrato'].'</td>
  ...
  <tr>
    <td>
      <table width="100%" cellpadding="3">
        <tr>
          <td class="bggray cabecera3" width="65">NOMBRE:</td>
          <td width="200">'.$titular.'</td>
          <td class="bggray cabecera3" width="70">CARNET:</td>
...
<table border="0" align="center" cellpadding="2" width="100%">
  <tr style="background-color:#dddddd;">
    ...
    <td class="cabecera2 textocentro" width="48"> EJECUTIVO </td>
    <td class="cabecera2 textocentro" width="110"> DETALLE </td>
  </tr>';
$pdf->SetFont('helvetica', '', 7);
    foreach($cobcarteradet->mostrarTodo("idcartera=$valor") as $f)
    {
      ...
      <tr>
        ...
        <td class="sfila textocentro"> '.$dus['usuario'].'</td>
        <td class="sfila textocentro"> '.$f['fechaBase'].' '.$f['glosa'].'</td>
      </tr>';
    }
  $html=$html.'
