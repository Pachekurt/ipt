              ...
              <div class="row">
                <form id="idform" action="return false" onsubmit="return false" method="POST">
                  <table id="example" class="display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <?php
                      foreach($cobcartera->mostrarTodo("idejecutivo=$idejecutivo and estado>130 ") as $f)
                      {
                      ...
                      <tr style="<?php echo $styleP ?>">
                        ...
                        <td><a href="cobrar/?lblcode=<?php echo $lblcode ?>" class="btn-jh blue darken-4"><i class="mdi-action-assignment-turned-in
"></i> COBRAR</a></td>
                      </tr>
                      <?php
                        }
