            ...
            <div class="section">
             ...
             <!-- <a href="../inicio" class="btn waves-effect waves-light blue"><i class="fa fa-reply"></i> Atras</a> -->
              ...
              <div class="row">
                ...
                <tbody>
                      <?php
                      foreach($admestudiante->mostrarTodo("  estado in(1,2)") as $f)
                      {
                      ...
                      <tr style="<?php echo $style.$style1 ?>" >
                        ...
                        <td><?php 
                          $datosede=$sede->muestra($f['idsede']);
                        echo $datosede['nombre'];
                        ...
                        <td>
                           <!-- <a href="modificar.php?idecod=<?php echo $idest ?>" class="btn-jh waves-effect waves-light blue"><i class="mdi-content-create"></i> Editar</a>-->
                            <a href="transferir.php?idecod=<?php echo $idest ?>" class="btn-jh waves-effect waves-light green tooltipped" target="_blank" data-position="bottom" data-delay="50" data-tooltip="VER KARDEX">TRANSFERIR<i class="mdi-action-assignment-turned-in"></i>  </a>
                       </td>
