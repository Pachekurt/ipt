             ...
             <!-- <a href="../inicio" class="btn waves-effect waves-light blue"><i class="fa fa-reply"></i> Atras</a> -->
              ...
              <div class="row">
                ...
                <tbody>
                      ...
                      ?>
                      <?php switch ($f['asignacion']) {
                        case 'ASIGNADO':
                            $style="background-color:#e0f2f1;color: #27a02a";
                             
                          break;
                        case 'ABANDONO':
                           $style="background-color:#F2E0E1;color: #E81F0C";
                             
                          break;
                           case 'POR ASIGNAR':
                           $style="background-color:#D7FFAE;color: #F2A325";
                      ...
                      <tr style="<?php echo $style ?>" >
                        ...
                        <td><?php echo $f['asignacion'] ?></td>
                        <td>
                             <a href="../licencia/licencia.php?idecod=<?php echo $idest ?>" class="btn-jh waves-effect waves-light green" target="_blank"><i class="mdi-content-forward"></i>Solicitar licencia</a>
                        </td>
                      </tr>
                      <?php
                        }
