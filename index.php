    ...
    <div class="col s12 z-depth-4 card-panel">
        <div class="row">
          <div class="input-field col s12 center"><br>
            ...
            <p class="center login-form-text">Sistema Administrativo</p>
            <?php
          ...
          <div class="row">
            <div class="input-field col s12">
              ...
              <input type="submit" id="idLog" name="idLog" class="btn waves-effect blue waves-light darken-4 col s12"  value="INGRESAR AL SISTEMA">
                 ...
                 <div class="row">
            <div class="input-field col s12"> 
              <a   class="btn waves-effect green waves-light darken-4 col s12" href="https://inglesipt.com:2096/" target ="_blank">CORREO COORPORATIVO</a>
            </div>
          </div>
          </div>
        </form>
