<?php
  ...
  $dpp=$personaplan->muestra($valor);

  $lblcontrato=$dpp['idcontrato'];
  $lblcode=ecUrl($lblcontrato);
...
<body>
              ...
              <input id="idpersona" name="idpersona" value="<?php echo $dtit['idpersona'] ?>" type="hidden">
                <div class="col s6 m6 l6">
                    ...
                    <div class="formcontent">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <a id="btnSave" class="btn waves-effect darken-3 green"><i class="fa fa-save"></i> Cambiar Plan</a>
                        </div>
                      </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
      ...
      $("#btnSave").click(function(){
        ...
        str=str+"&lblcode="+"<?php echo $lblcode ?>"+"&lblcontrato=<?php echo $lblcontrato ?>"+"&idpp=<?php echo $valor ?>";
        //alert(str);
        swal({
            title: "CONFIRMACION",
    ...
    function cargaDato(id){
      ...
      $.ajax({
        async: true,
        url: "../nuevo/cargarPlan.php?id="+id.value,
        type: "get",
        dataType: "html",
