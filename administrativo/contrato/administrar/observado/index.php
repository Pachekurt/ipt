...
<body>
        ...
        <section id="content">
          ...
          <div class="container">
            <div class="row">
                  ...
                  <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                      <a href="../" class="btn blue darken-3"><i class="fa fa-reply"></i> volver</a href="../">
                        <a href="../titular/editar/?lblcode=<?php echo $lblcode ?>" target="_blank" class="btn purple darken-3"><i class="fa fa-edit"></i> Editar Datos</a href="../">
                      <ul id="dropdown2" class="dropdown-content">
                        ...
                        <li><a target="_blank" href="../../auditoria/ver/fotos.php?lblcode=<?php echo $lblcode ?>">Ver fotos<span class="badge"><i class="mdi-image-portrait"></i></span></a></li>
                      </ul>
                  ...
                  <div class="col s12 m8 l12">
                    <ul class="collapsible popout collapsible-accordion" data-collapsible="accordion">
                        ...
                        <div class="collapsible-body">
                          ...
                          <table class="cssdato">
                            ...
                            <tr>
                              ...
                              <td><?php echo $dcontrato['idadmsemana'] ?></td>
                            ...
                            <tr>
                              ...
                              <td class="sub">Meses</td>
                              <td><?php echo $dplan['cuotas'] ?></td>
                            </tr>
                            <tr>
                      ...
                      <li>
                        ...
                        <div class="collapsible-body">
                          <?php
                            $ddom=$domicilio->mostrarUltimo("idpersona=".$dtit['idpersona']." and (indicador=1 or tipoDomicilio='PRINCIPAL')");
                            //echo $dtit['idpersona'];
                          ?>
                          <table class="cssdato">
                            <tr>
              ...
              <?php
              $dobs=$admcontratodelle->mostrarUltimo("idcontrato=".$valor." and codigo=3117");

              ?>
                <div class="col s12 m6 l6">
                  <div class="formcontent">
                    <div class="titulo">Observacion por Auditoria</div>
                    <div class="col s12 m12 l12">
                        <div class="row">
                          <div class="input-field col s12">
                            <textarea id="idobs3" name="idobs3" class="materialize-textarea"><?php echo $dobs['detalle'] ?></textarea>
                            <label for="idobs3">OBSERVACION REALIZADA POR AUDITORIA</label>
                          </div>
                        </div>
                    </div>&nbsp;
                  </div>
                ...
                <div class="col s12 m6 l6">
                  <div class="formcontent">
                    <div class="titulo">Solucion de la observacion</div>
                    <div class="col s12 m12 l12">
                      ...
                      <div class="row">
                          <div class="input-field col s12">
                            ...
                            <label for="idobs">ALGO QUE QUIERA AGREGAR ?</label>
                          </div>
                          <div class="input-field col s12 m6 l12">
                            <center>
                              <button id="btnSave" class="btn darken-4 green" style="width: 100%"><i class="fa fa-check"></i> Subsanara Observacion</button>
                            </center>
                          </div> 
                        </div>
                      </form>
    ...
    <script type="text/javascript">
      ...
      $("#btnSave").click(function(){
        ...
        swal({
          title: "CONFIRMACION",
          text: "Se guardara Enviará la Corrección a Auditoría",
          type: "warning",
