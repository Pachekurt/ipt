...
$dominio=new dominio;
include_once($ruta."class/vcontratodetalle.php");
$vcontratodetalle=new vcontratodetalle;
...
<table width="100%"  align="center">
          <tr>
            ...
            <td><br>
            <div class="tituloFactura">HISTORIAL DEL CONTRATO</div>
            </td>
            <td><br>
            <table border="1">
              <tr>
...
<table border="0" cellpadding="2" width="704">
  <tr style="background-color:#dddddd;">
    ...
    <td class="cabecera2 textocentro" width="50"> HORA </td>
    <td class="cabecera2 textocentro" width="160"> DETALLE </td>
    <td class="cabecera2 textocentro" width="180"> OBSERVACIONES </td>
    <td class="cabecera2 textocentro" width="80"> ESTADO </td>
  </tr>';
$pdf->SetFont('helvetica', '', 8);
    foreach($vcontratodetalle->mostrarTodo("idcontrato=".$valor) as $f){
      $html=$html.'
      <tr>
        <td class="sfila textocentro"> '.$f['fecha'].'</td>
        <td class="sfila textocentro"> '.$f['hora'].'</td>
        <td class="sfila"> '.$f['detEn'].'</td>
        <td class="sfila"> '.$f['obs'].'</td>
        <td class="sfila textocentro"> '.$f['estado'].'</td>
      </tr>';
    }
  $html=$html.'
