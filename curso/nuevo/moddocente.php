...
<head>
    <?php
      $hd_titulo="CAMBIO DE DOCENTE DEL CURSO";
                                                 ...
                                                 <div class="card-content">
                                                    ...
                                                    <ul data-method="GET" class="stepper horizontal"> <!-- stepper linear -->
                                                          ...
                                                          <div class="step-content">
                                                                    <div class="row">
                                                                          ...
                                                                          <div class="input-field col s12 m9">
                                                                            <label>Modulo</label>
                                                                            <select id="idmodulo" name="idmodulo" disabled>
                                                                    ...
                                                                    <div class="row">
                                                                          ...
                                                                          <div class="input-field col s12 m9">
                                                                            ...
                                                                            <select id="idhorario" name="idhorario" disabled>
                                                                              <option value="0">Seleccionar Horario...</option>
                                                                              <?php
                                                                              foreach($horario->mostrarTodo("") as $or)
                                                                              {
                                                                                ?>
                                                                                 <option <?php if ($cu['idhorario']==$or['idhorario']) echo "selected";?> value="<?php echo $or['idhorario'];  ?>" ><?php echo $or['inicio']." a ".$or['fin'] ?></option>
                                                                                <?php
                                                                              }
                                                                              ?>
                                                                            </select>
                                                                     ...
                                                                     <div class="row">
                                                                      <div class="input-field col col s12 m6">
                                                                        <input id="idfechaini" name="idfechaini" type="hidden" class="validate"   value="<?php echo $cu['fechainicio']; ?>"> 
                                                                      </div>
                                                                      <div class="input-field col col s12 m6">
                                                                        <input id="idfechafin" name="idfechafin" type="hidden" class="validate"   value="<?php echo $cu['fechafin']; ?>"> 
                                                                      </div>
                                                                    </div>
                                                                    <div class="row">
                                                                      <div class="input-field col s12">
                                                                        <textarea id="iddesc" name="iddesc" disabled class="materialize-textarea"><?php echo $cu['descripcion']; ?></textarea>
                                                       ...
                                                       <li class="step active">
                                                          <div class="step-title waves-effect waves-dark"><strong>Modificar asignación de Docente</strong> </div>
                                                          <div class="step-content">
                                                            <?php 
                                                                 $vej=$vejecutivo->mostrar($cu['idejecutivo']);
                                                                  $vej=array_shift($vej);
                                                                  $nombre=$vej['nombre']." ".$vej['paterno']." ".$vej['materno'];
                                                             ?>
                                                                      <input type="hidden" name="idejecutivoInport" id="idejecutivoInport" value="<?php echo $cu['idejecutivo']; ?>">
                                                                    <div class="row">
                                                                      <div class="input-field col s12 m3">
                                                                             <strong>Docente:</strong>
                                                                          </div>
                                                                      <div class="input-field col s12 m9">
                                                                        <input id="idnombreInport" name="idnombreInport" type="text" disabled class="validate" style="color:#191919;" value="<?php echo $nombre ?>">
