...
<head>
    <?php
      $hd_titulo="Asignar alumnos a nuevo curso";
            ...
            <div class="section">
             ...
             <!-- <a href="../inicio" class="btn waves-effect waves-light blue"><i class="fa fa-reply"></i> Atras</a> -->
              ...
              <div class="row">
                ...
                <tbody>
                      <?php
                      foreach($estudiante->mostrarTodo("idsede=".$idsede." and estado =1 and idmodulo>=2") as $f)
                      {
                        $per=$persona->mostrarTodo("idpersona=".$f['idpersona']);
                        $per=array_shift($per);
                        $idest=ecUrl($f['idestudiante']);

                        $estC=$estudiantecurso->mostrarTodo("idestudiante=".$f['idestudiante']." and estado=1 and estadoexamen =1");
                      ?>
                      <tr
                      <?php 
                         if (count($estC)>0) 
                      ...
                      >
                        ...
                        <td><?php echo 'Modulo '.$f['idmodulo'] ?></td>
                        <td>
