          ...
          <div class="container">
            <div class="section">
             ...
             <!-- <a href="../inicio" class="btn waves-effect waves-light blue"><i class="fa fa-reply"></i> Atras</a> -->
              ...
              ?>
              <h1><?php echo "HORARIO: ".$datohorario['inicio']." a ".$datohorario['fin'] ?></h1>
              <div class="row">
                ...
                <tbody>
                      <?php
                      foreach($vcurso->mostrarTodo("idhorario=$idhor") as $f)
                      {
                      ...
                      <tr>
                        ...
                        <td><button class="btn-jh waves-effect waves-light light-blue darken-4" onclick="ver('<?php echo $idcurso ?>');"><i class="mdi-av-my-library-books"></i> Ver Curso</button></td>  
                      </tr>
                      <?php
                        }
                      ?>
