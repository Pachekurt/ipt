...
$pdf->AddPage();
    ...
    $datohorario=   $horario->muestra($idhor);
 
    $pdf->Ln(5);
    $pdf->SetFont('Arial', '', 12  );
    $pdf->Ln(5);
    $pdf->Cell(20,4);
    $pdf->Cell(25, 4,"HORARIO: ".$datohorario['inicio']." a ".$datohorario['fin'], $linea);
    $saltoLinea=4;
 ...
 $pdf->Ln(10);
        ...
        $pdf->Cell(20,0);
        $pdf->Cell(60, $saltoLinea, 'DOCENTE', $linea);
        $pdf->Cell(60, $saltoLinea, 'FECHA DE INICIO', $linea);
        $pdf->Cell(60, $saltoLinea, 'FECHA DE FIN', $linea);
        $pdf->Cell(20,0);
    ...
    $i=1;
      $Casis=0;
      $Cfaltas=0;
    foreach($vcurso->mostrartodo("idhorario=$idhor") as $dcurso)
    {
        $pdf->Ln($saltoLinea);
        $pdf->Cell(20,0);
        $pdf->Cell(60, $saltoLinea, $dcurso['nombre']." ".$dcurso['paterno'],     $linea);      
        $pdf->Cell(60, $saltoLinea, $dcurso['fechainicio'],     $linea);
        $pdf->Cell(60, $saltoLinea, $dcurso['fechafin'],     $linea);
        $pdf->Cell(20,0);
        $i++;    
    }
