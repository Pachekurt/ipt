                          ...
                          <div class="col s12 m12 l12" >
                            ...
                            <div class="card-content red-text">
                             <p> <strong>MODULO: </strong><label id="moduloEC" style="color:#252525; font-size:15px;"></label></p>
                              ...
                              <p> <strong>FECHA INICIO: </strong><label id="fechainicioEC" style="color:#252525; font-size:15px;"></label></p>
                              <p> <strong>FECHA FIN: </strong><label id="fechafinEC" style="color:#252525; font-size:15px;"></label></p>
                            </div>
                         </div>
