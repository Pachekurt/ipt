...
<head>
    <?php
      $hd_titulo="Asignar alumnos a curso";
            ...
            <div class="section">
             ...
             <!-- <a href="../inicio" class="btn waves-effect waves-light blue"><i class="fa fa-reply"></i> Atras</a> -->
              ...
              <div class="row">
                ...
                <tbody>
                      <?php
                      foreach($vestudiantefull->mostrarTodo("idsede=".$idsede." and estado =1   and estadocontrato in (142,143,145,154) and estadoacademico not in(150,151,152)") as $f)
                      {
                         
                        $idest=ecUrl($f['idestudiante']);

                        $estC=$estudiantecurso->mostrarTodo("idestudiante=".$f['idestudiante']." and estado=1");
                      ?>
                      <tr
                      <?php 
                         if (count($estC)>0) 
                         {
                          ...
                          <?php
                            ...
                            ?>
                            style="background-color:#cff1d0;color: #27a02a"
                          <?php
                         }
                       ?>
                      >
                        ...
                        <td>
                           ...
                           {
                             ?>
                            <!-- <a href="../traspaso/traspaso.php?lblcode=<?php echo $idest ?>" class="btn-jh waves-effect red"><i class="mdi-action-assignment"></i> Traspasar</a> -->
                            ...
                            <?php
                              ...
                              ?>
                              <a href="asignar.php?lblcode=<?php echo $idest ?>" class="btn-jh waves-effect waves-light blue"><i class="mdi-action-assignment"></i> Asignar curso</a>
