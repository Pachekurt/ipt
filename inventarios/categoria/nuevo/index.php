...
<body>
                                ...
                                <div class="card-content">
                                  <ul data-method="GET" class="stepper horizontal"> <!-- stepper linear -->
                                    <li class="step active">
                                      <div class="titulo waves-effect waves-dark"><i class="fa fa-plus"></i> <strong>Datos de la Categoria</strong> </div>
                                      <div class="step-content">
                                        ...
                                        <div class="step-actions">
                                          <button id="btnSave" class="btn waves-effect light-blue darken-4 indigo"> <i class="fa fa-save"></i> Guardar Categoria </button><!--  -->
                                        </div>
                                      </div>
                                    </li>
                                  </ul>
    ...
    $(document).ready(function() {
      ...
      $("#btnSave").click(function(){
        swal({   
          title: "Estas Seguro?",   
          text: "Esta Seguro de Crear Categoria?",   
          type: "warning",   
